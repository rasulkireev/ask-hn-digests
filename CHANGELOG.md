...
## [Unreleased]
### Changed
- Now using uv instead of poetry
- Upgraded to Django 6

## Fixed
- django-allauth confirmation sending
- django-ninja csrf setting

## [0.0.3] - 2025-08-19
### Added
- generation of reddit posts

### Fixed
- NoReverse issue on the home page, but changing slug in the url to str
- write tweet as a person
- fix the layout of the post card

### Changed
- Updated timeout to be one hour
- i no longer create tweet for all summaries, only the ones i select
- rules for generating reddit post
